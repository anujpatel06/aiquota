...
CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "adapter": "manual",
        "support": "soon",
        "note": "Premium request quota; org API exists, personal not documented",
        "login": "github.com → Settings → Copilot",
    },
    {
        "key": "gemini",
        "name": "Gemini",
        ...
        "adapter": "manual",
        "support": "manual",
        "note": "No consumer quota API; AI Studio shows API-tier limits only",
    ...
    },
    {
        ...
        "adapter": "manual",
        "support": "soon",
        "note": "Character quota — /v1/user/subscription exists (needs API key)",
        "login": "elevenlabs.io → Profile → API key",
    },
    {
        "key": "suno",
        "name": "Suno",
    ...
    },
    {
        ...
        "adapter": "manual",
        "support": "soon",
        "note": "Credit balance — /api/v1/credits exists (needs API key)",
